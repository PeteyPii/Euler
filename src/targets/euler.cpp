...
void verifyResults() {
  ...
  const fpCheck checks[] = {
      ...
      []() -> bool { return assertEquality(problem104(), 329468); },
      []() -> bool { return assertEquality(problem105(), 73702); },

      []() -> bool { return assertEquality(problem106(12), 21384); },
      []() -> bool { return assertEquality(problem107(), 259679); },
  };
